//! Specifications for EngagementRating aggregate
//!
...
// Each predicate implements `Specification<EngagementRating>` and can be combined
...
//
// pub struct ActiveEngagementRatingSpec;
// impl Specification<EngagementRating> for ActiveEngagementRatingSpec {
//     fn is_satisfied_by(&self, e: &EngagementRating) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
