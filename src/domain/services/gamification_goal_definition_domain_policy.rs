//! Domain policy for GamificationGoalDefinition aggregate
//!
...
/// Domain policy for GamificationGoalDefinition — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<GamificationGoalDefinition>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type GamificationGoalDefinitionDomainPolicy = PermitAllPolicy<GamificationGoalDefinition>;
