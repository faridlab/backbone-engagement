//! Domain policy for GamificationChallengeMembership aggregate
//!
...
/// Domain policy for GamificationChallengeMembership — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<GamificationChallengeMembership>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type GamificationChallengeMembershipDomainPolicy = PermitAllPolicy<GamificationChallengeMembership>;
