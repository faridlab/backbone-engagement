//! Domain policy for EngagementMedium aggregate
//!
...
/// Domain policy for EngagementMedium — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<EngagementMedium>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EngagementMediumDomainPolicy = PermitAllPolicy<EngagementMedium>;
