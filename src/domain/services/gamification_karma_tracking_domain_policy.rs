//! Domain policy for GamificationKarmaTracking aggregate
//!
...
/// Domain policy for GamificationKarmaTracking — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<GamificationKarmaTracking>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type GamificationKarmaTrackingDomainPolicy = PermitAllPolicy<GamificationKarmaTracking>;
