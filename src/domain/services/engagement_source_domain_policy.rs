//! Domain policy for EngagementSource aggregate
//!
...
/// Domain policy for EngagementSource — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<EngagementSource>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EngagementSourceDomainPolicy = PermitAllPolicy<EngagementSource>;
