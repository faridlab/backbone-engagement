//! Domain policy for GamificationGoal aggregate
//!
...
/// Domain policy for GamificationGoal — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<GamificationGoal>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type GamificationGoalDomainPolicy = PermitAllPolicy<GamificationGoal>;
