//! Domain policy for GamificationBadge aggregate
//!
...
/// Domain policy for GamificationBadge — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<GamificationBadge>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type GamificationBadgeDomainPolicy = PermitAllPolicy<GamificationBadge>;
