//! Domain policy for GamificationKarmaRank aggregate
//!
...
/// Domain policy for GamificationKarmaRank — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<GamificationKarmaRank>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type GamificationKarmaRankDomainPolicy = PermitAllPolicy<GamificationKarmaRank>;
