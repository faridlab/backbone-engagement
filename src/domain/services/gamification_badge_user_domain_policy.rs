//! Domain policy for GamificationBadgeUser aggregate
//!
...
/// Domain policy for GamificationBadgeUser — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<GamificationBadgeUser>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type GamificationBadgeUserDomainPolicy = PermitAllPolicy<GamificationBadgeUser>;
