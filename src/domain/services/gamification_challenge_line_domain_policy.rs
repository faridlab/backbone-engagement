//! Domain policy for GamificationChallengeLine aggregate
//!
...
/// Domain policy for GamificationChallengeLine — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<GamificationChallengeLine>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type GamificationChallengeLineDomainPolicy = PermitAllPolicy<GamificationChallengeLine>;
