//! Domain policy for EngagementCampaign aggregate
//!
...
/// Domain policy for EngagementCampaign — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<EngagementCampaign>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EngagementCampaignDomainPolicy = PermitAllPolicy<EngagementCampaign>;
