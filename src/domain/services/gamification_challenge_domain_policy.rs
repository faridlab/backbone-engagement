//! Domain policy for GamificationChallenge aggregate
//!
...
/// Domain policy for GamificationChallenge — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<GamificationChallenge>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type GamificationChallengeDomainPolicy = PermitAllPolicy<GamificationChallenge>;
