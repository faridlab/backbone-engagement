//! Domain policy for EngagementRating aggregate
//!
...
/// Domain policy for EngagementRating — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<EngagementRating>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EngagementRatingDomainPolicy = PermitAllPolicy<EngagementRating>;
