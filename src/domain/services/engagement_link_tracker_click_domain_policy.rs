//! Domain policy for EngagementLinkTrackerClick aggregate
//!
...
/// Domain policy for EngagementLinkTrackerClick — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<EngagementLinkTrackerClick>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EngagementLinkTrackerClickDomainPolicy = PermitAllPolicy<EngagementLinkTrackerClick>;
