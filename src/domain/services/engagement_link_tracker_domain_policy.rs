//! Domain policy for EngagementLinkTracker aggregate
//!
...
/// Domain policy for EngagementLinkTracker — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<EngagementLinkTracker>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EngagementLinkTrackerDomainPolicy = PermitAllPolicy<EngagementLinkTracker>;
